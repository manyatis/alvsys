          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <CodeBlock
                  code='claude mcp add --transport http alvsys https://https://alvsys.com/api/llm/mcp --header "X-Project-Id: YOUR_PROJECT_ID" --header "Authorization: Bearer YOUR_API_KEY"'
                  copyId="mcp-install"
                />
              </div>
