          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-gray-400 ml-4">
                    <li>Sign up at <a href="https://www.alvsys.com" className="text-emerald-400 hover:text-emerald-300 underline">www.alvsys.com</a></li>
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <CodeBlock
                  code='claude mcp add --transport http alvsys https://www.alvsys.com/api/llm/mcp --header "X-Project-Id: YOUR_PROJECT_ID" --header "Authorization: Bearer YOUR_API_KEY"'
                  copyId="mcp-install"
                />
              </div>
