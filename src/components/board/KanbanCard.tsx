      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          {card._count && card._count.comments > 0 && (
            <div className="flex items-center gap-0.5 sm:gap-1 px-1 sm:px-1.5 py-0.5 text-xs font-medium rounded border bg-gray-100 text-gray-600 border-gray-200 dark:bg-gray-600 dark:text-gray-300 dark:border-gray-500">
