          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center h-full">
              ...
              <a 
                ...
                className="px-2 md:px-3 h-full flex items-center gap-1 text-xs text-slate-600 dark:text-slate-300 hover:text-white active:text-white font-medium hover:bg-purple-700 active:bg-purple-700 rounded-lg transition-all duration-500"
              >
        ...
        <div className={`md:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border-t border-slate-200 dark:border-slate-700 transition-all duration-300 ${
          ...
          <div className="px-6 py-4 space-y-2">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 w-full text-left px-4 py-3 text-slate-600 dark:text-slate-300 hover:text-white active:text-white hover:bg-purple-700 active:bg-purple-700 rounded-lg font-medium transition-all duration-300 text-sm"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
